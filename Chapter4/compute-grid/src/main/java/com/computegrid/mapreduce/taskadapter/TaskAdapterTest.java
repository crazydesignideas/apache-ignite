...
public class TaskAdapterTest {
	public static void main(String[] args) {
		...
		try (Ignite ignite = Ignition.start(cfg)) {
			...
			double totalCalculatedExpense = compute.execute(ClubExpenseTaskAdapter.class, clubNames);
			System.out.println(String.format("Total Expense  calculated=%s, expected=%s", totalCalculatedExpense,
					expectedExpense));
		}
	}
}
